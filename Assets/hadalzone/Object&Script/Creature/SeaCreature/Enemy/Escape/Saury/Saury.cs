...
class Saury : Interception {
    ...
    public override void Intercept() {
        transform.localRotation = enemyView.LookAnPlayer(player, myposition, myrotation, LookSpeed * 1.5f);//Playerの逆を見る
        transform.localScale = enemyView.Reversi(myrotation);
